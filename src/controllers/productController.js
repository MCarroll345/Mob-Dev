...
exports.createProduct('/products', async (req, res) => {
  try {
...
// READ all products
exports.getProducts('/products', async (req, res) => {
  try {
...
exports.updateProduct('/products/:id', async (req, res) => {
  try {
    const { id } = req.params;
...
exports.deleteProduct('/products/:id', async (req, res) => {
  try {
    const { id } = req.params;
